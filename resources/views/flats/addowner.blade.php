			...
			<div class="inner-wrapper">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Add Owner</h2>
                        ...
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-lg-12 offset-lg-2">
                                    <form action="{{ route('owner.store') }}" method="POST" id="form" class="validate">
									@csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label> Total Cost of Flat <span class="required">*</span></label>
                                                    <input class="form-control" name="total_cost" type="text" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="paid_amount" type="text" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label> Pending Amount <span class="required">*</span></label>
                                                    <input class="form-control" name="pending_amount" type="text" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="phone_no" type="Phone" required/>
                                                </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
