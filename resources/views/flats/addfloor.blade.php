			...
			<div class="inner-wrapper">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Add Floor/Flat Expenses</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-12 offset-lg-2">
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" value="BKG-0001" readonly="" required>                                               </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-j72y-container"><span class="select2-selection__rendered" id="select2-j72y-container" title="Jennifer Robinson">Jennifer Robinson</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span> -->
                                               <!--  </div>
                                            </div>
                                        </div>  -->

                                       
                                        <form action="{{ route('flats.store') }}" method="POST" id="form" class="validate">
    										@csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label> Flat No. <span class="required">*</span></label>
                                                    <input class="form-control" name="flat_no" type="text" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label> Floor No <span class="required">*</span></label>
                                                    <input class="form-control" name="floor_no" type="text" required=""/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label> Building Material <span class="required">*</span></label>
              
                                                    <input class="form-control" name="building_material" type="text" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="unit_no" type="text" required />
                                                </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label> Total Expenses <span class="required">*</span></label>
                                                    <input class="form-control" name="total_expenses" type="text" required />
                                                </div>
                                            </div>
