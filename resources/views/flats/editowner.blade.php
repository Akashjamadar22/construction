			...
			<div class="inner-wrapper">
                ...
                <div class="row">
                    <div class="col-sm-5 col-4">
                        <h4 class="page-title">Edit Owner</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 offset-lg-2">
                        <form action="{{ route('owner.update',$owner->id) }}" method="POST" id="form" class="validate">
							@csrf
        					@method('PUT')
                            	<div class="row">
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                        	...
                                        	<input class="form-control" value="{{ $owner->name }}" name="name" type="text" required>
                                    	</div>
                                	</div>
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                        	<label> Flat No <span class="text-danger">*</span></label>
                                        	<input class="form-control" value="{{ $owner->flat_no }}" name="flat_no" type="text" required>
                                    	</div>
                                	</div>
                            	</div>
                            	<div class="row">
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                        	...
                                        	<div class="cal-icon">
                                            	<input class="form-control datetimepicker" type="text" value="{{ $owner->floor_no }}" name="floor_no" required>
                                        	</div>
                                    	</div>
                                	</div>
                                	<div class="col-sm-6">
                                   		<div class="form-group">
                                        	<label> Total Cost of Flat <span class="text-danger">*</span></label>
                                        	<div class="cal-icon">
                                            	<input class="form-control datetimepicker" type="text" value="{{ $owner->total_cost }}" name="total_cost" required>
                                        	</div>
                                    	</div>
									</div>
                            	</div>
                        		<div class="row">
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                        	...
                                        	<div class="cal-icon">
                                            	<input class="form-control datetimepicker" type="text" value="{{ $owner->paid_amount }}" name="paid_amount" required>
                                        	</div>
                                    	</div>
                                	</div>
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                        	...
                                        	<div class="cal-icon">
                                            	<input class="form-control datetimepicker" type="text" value="{{ $owner->pending_amount }}" name="pending_amount" required>
                                        	</div>
                                    	</div>
									</div>
                        		</div>
								<div class="row">
                                	<div class="col-sm-6">
                                    	<div class="form-group">
                                        	...
                                        	<div class="cal-icon">
                                            	<input class="form-control datetimepicker" type="phone" value="{{ $owner->phone_no }}" name="phone_no" required>
                                        	</div>
                                    	</div>
                                	</div>
									<div class="col-sm-6">
                                    	<div class="form-group">
                                        	...
                                        	<div class="cal-icon">
                                            	<input class="form-control datetimepicker" type="email" value="{{ $owner->email }}" name="email" required>
                                        	</div>
                                    	</div>
									</div>
								</div>
