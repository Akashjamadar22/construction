						...
						<div class="panel-body">
							 ...
							 <div class="content">
                				<div class="row">
                        			...
                        			<h4 class="page-title">FLATS EXPENSES / UNIT</h4>
                    				</div>

									<div class="col-sm-7 col-8 text-right m-b-30">
                        			<a href="{{ route('flats.create') }}" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Floor/Flat Expenses</a>
                    				</div>
                				</div>
								<br>
                        ...
                        <table class="table table-bordered table-striped mb-none dataTable" id="datatable-editable">
                            ...
                            <tbody>
        						...
        						<tr>
            						<td>{{ ++$i }}</td>
            						<td>{{ $value->flat_no }}</td>
            						<td>{{ \Str::limit($value->floor_no, 100) }}</td>
									<td>{{ $value->total_expenses }}</td>
									<td>
									<select class="form-control" required>
                                            <option selected="Pending">Saled</option>
									...
									<td>
										...
										<a href="{{ route('flats.edit',$value->id) }}" class="btn btn-primary">Edit</a>
			
										@csrf
                   						 @method('DELETE')      
                    					<button class="btn btn-danger openModal">Deleet</button>
										<div class="modal">
										<div class="modalContent">
										<span class="close">×</span>
										<p>Are you sure you want to delete your account</p>
										<form action="{{ route('flats.destroy',$value->id) }}" method="POST">
