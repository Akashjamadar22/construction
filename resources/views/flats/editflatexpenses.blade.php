			...
			<div class="inner-wrapper">
                ...
                <div class="row">
                    <div class="col-sm-5 col-4">
                        <h4 class="page-title">Edit Flat Expenses</h4>
                    </div>
                ...
                <div class="row">
					...
					<form action="{{ route('flats.update',$flat->id) }}" method="POST" id="form" class="validate">
        				@csrf
        				@method('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $flat->flat_no }}" name="flat_no" type="text" required="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label> Floor No <span class="text-danger">*</span></label>
                                        <input class="form-control" value="{{ $flat->floor_no }}" name="floor_no" type="text" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="building_material" value="{{ $flat->building_material }}" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="from" value="{{ $flat->from }}" required="">
                                        </div>
                                    </div>
                                </div>
							...
							<div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="unit_no" value="{{ $flat->unit_no }}" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="total_expenses" value="{{ $flat->total_expenses }}" required="">
                                        </div>
                                    </div>
                                    <!-- <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-s4fu-container"><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span> -->
                                    </div>
                                </div>
                            </div>
